...
def evaluate_test_predictions(padded_X_word_test, padded_Y_test, pred_ids, label2id, id2label, num_classes):
...
def run_visualizations(raw_test_tokens, raw_test_bio_labels, raw_all_tokens, pred_ids, label2id, id2label, num_classes, eval_bundle):
    ...
    plot_performance_by_sentence_length(
        ...
        exclude_o=False,
        metric="accuracy",
        bins=[(0, 40), (41, 80), (81, 120), (121, 150)],
    ...
    # plot_sentence_length_distribution(raw_tokens=raw_all_tokens, max_line=150, output_path="sentence_length_distribution.png")